...
class LikeEquipmentPop extends StatefulWidget {
  final FavoriteController controller;
  const LikeEquipmentPop({super.key, required this.controller});

  @override
  State<LikeEquipmentPop> createState() => _LikeEquipmentPopState();
}

class _LikeEquipmentPopState extends State<LikeEquipmentPop> {
  @override
  void initState() {
